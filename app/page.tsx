        ...
        <div className="mx-auto grid max-w-7xl items-stretch gap-0 lg:grid-cols-2">
          ...
          <div className="flex items-center px-8 py-16 sm:px-14">
            <FadeUp>
              ...
              <h2 className="display-2 mt-5 text-bone">A charming, <em className="not-italic text-coral">self-contained</em> studio</h2>
              ...
              <ul className="mt-7 flex flex-wrap gap-2">
                {facts.map((f) => (
                  <li key={f} className="rounded-full bg-bone/10 px-4 py-1.5 text-sm text-bone">{f}</li>
                ))}
              </ul>
